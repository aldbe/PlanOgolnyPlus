...
SOURCES = \
	__init__.py \
	plan_ogolny.py plan_ogolny_dialog.py

PLUGINNAME = plan_ogolny

PY_FILES = \
	__init__.py \
	plan_ogolny.py plan_ogolny_dialog.py

UI_FILES = plan_ogolny_dialog_base.ui
...
QGISDIR=C:\Users\aldon\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
